...
static inline cf21_t* normalize_dense_matrix_row_ff_21(
    ...
    printf("normalize_dense_matrix_row_ff_21 called\n");
    len_t i;
...
static inline cf21_t* normalize_sparse_matrix_row_ff_21(
    ...
    printf("normalize_sparse_matrix_row_ff_21 called\n");
    len_t i;
...
{
    printf("reduce_dense_row_by_known_pivots_sparse_ff_21 called\n");
    hi_t i, j, k;
    cf21_t *cfs;
    hm_t *dts;
    int64_t np = -1;
